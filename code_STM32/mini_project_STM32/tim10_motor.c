...
GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_11; // SERVO
...
*/
  ...
  TIM_TimeBaseStructure.TIM_Prescaler = 168-1;         //168Mhz/168 = 1MHz(1us)  * 20000 = 20ms
  ...
  TIM_OCInitStructure.TIM_Pulse = 950-1;         //50% duty
